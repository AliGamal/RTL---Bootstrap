<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="components.aspx.cs" Inherits="components" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        $(function () {
            $(".bs-docs-nav .navbar-nav>li>a").removeClass("active");
            $("#menu-components").addClass("active");
        });
</script>
</asp:Content>
    ...
    <div class="bs-docs-header" id="content" tabindex="-1">
        <div class="container">
            ...
            <div id="carbonads-container">
                <div class="carbonad">
                    <div id="azcarbon">
                        <span><span class="carbonad-image"><a href="//srv.carbonads.net/ads/click/x/GTND423ICT7DLKJMCWY4YKQWCKYDCKJLC6SIVZ3JCE7ITKJUCKBDPKQKC6BDCK3LF6BDVK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:getbootstrapcom;&amp;encredirect=http%3A%2F%2Fad.doubleclick.net%2Fddm%2Fjump%2FN9515.734586CARBONADS.NET%2FB8661482.117093741%3Bsz%3D130x100%3Bord%3D1430295295%3F" target="_blank">
                            <img width="130" height="100" border="0" src="https://ad.doubleclick.net/ddm/ad/N9515.734586CARBONADS.NET/B8661482.117093741;sz=130x100;ord=1430295295?" class="carbonad-image carbonad-img" style="max-width: 130px;"></a></span><span class="carbonad-text"><a href="//srv.carbonads.net/ads/click/x/GTND423ICT7DLKJMCWY4YKQWCKYDCKJLC6SIVZ3JCE7ITKJUCKBDPKQKC6BDCK3LF6BDVK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:getbootstrapcom;&amp;encredirect=http%3A%2F%2Fad.doubleclick.net%2Fddm%2Fjump%2FN9515.734586CARBONADS.NET%2FB8661482.117093741%3Bsz%3D130x100%3Bord%3D1430295295%3F">Hyperconverged Infrastructure for Dummies. Download your copy now.</a></span><span class="carbonad-tag">ads via <a href="http://carbonads.com">Carbon</a></span></span>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="leftPlaceHolder" runat="Server">
    ...
    <div class="bs-docs-section">
        <h1 id="glyphicons" class="page-header">Glyphicons<a class="  " href="#glyphicons"><span class="  "></span></a></h1>

        <h2 id="glyphicons-glyphs">Available glyphs<a class="  " href="#glyphicons-glyphs"><span class="  "></span></a></h2>
        ...
        <h2 id="glyphicons-how-to-use">How to use<a class="  " href="#glyphicons-how-to-use"><span class="  "></span></a></h2>
        <p>For performance reasons, all icons require a base class and individual icon class. To use, place the following code just about anywhere. Be sure to leave a space between the icon and text for proper padding.</p>
        <div class="bs-callout bs-callout-danger" id="callout-glyphicons-dont-mix">
            <h4 id="don't-mix-with-other-components">Don't mix with other components<a class="  " href="#don't-mix-with-other-components"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-danger" id="callout-glyphicons-empty-only">
            <h4 id="only-for-use-on-empty-elements">Only for use on empty elements<a class="  " href="#only-for-use-on-empty-elements"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-info" id="callout-glyphicons-location">
            <h4 id="changing-the-icon-font-location">Changing the icon font location<a class="  " href="#changing-the-icon-font-location"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
            <h4 id="accessible-icons">Accessible icons<a class="  " href="#accessible-icons"><span class="  "></span></a></h4>
        ...
        <h2 id="glyphicons-examples">Examples<a class="  " href="#glyphicons-examples"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="dropdowns" class="page-header">Dropdowns<a class="  " href="#dropdowns"><span class="  "></span></a></h1>
        ...
        <h2 id="dropdowns-example">Example<a class="  " href="#dropdowns-example"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="dropdowns-alignment">Alignment<a class="  " href="#dropdowns-alignment"><span class="  "></span></a></h2>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-dropdown-positioning">
            <h4 id="may-require-additional-positioning">May require additional positioning<a class="  " href="#may-require-additional-positioning"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-dropdown-pull-right">
            <h4 id="deprecated-.pull-right-alignment">Deprecated <code>.pull-right</code> alignment<a class="  " href="#deprecated-.pull-right-alignment"><span class="  "></span></a></h4>
        ...
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu dropdown-menu-right"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dLabel"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        </div>

        <h2 id="dropdowns-headers">Headers<a class="  " href="#dropdowns-headers"><span class="  "></span></a></h2>
        ...
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenu3"</span><span class="nt">&gt;</span>
  ...
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="dropdowns-divider">Divider<a class="  " href="#dropdowns-divider"><span class="  "></span></a></h2>
        ...
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenuDivider"</span><span class="nt">&gt;</span>
  ...
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="dropdowns-disabled">Disabled menu items<a class="  " href="#dropdowns-disabled"><span class="  "></span></a></h2>
        ...
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenu4"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="btn-groups" class="page-header">Button groups<a class="  " href="#btn-groups"><span class="  "></span></a></h1>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-btn-group-tooltips">
            <h4 id="tooltips-&amp;-popovers-in-button-groups-require-special-setting">Tooltips &amp; popovers in button groups require special setting<a class="  " href="#tooltips-&amp;-popovers-in-button-groups-require-special-setting"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-btn-group-accessibility">
            <h4 id="ensure-correct-role-and-provide-a-label">Ensure correct <code>role</code> and provide a label<a class="  " href="#ensure-correct-role-and-provide-a-label"><span class="  "></span></a></h4>
        ...
        <h2 id="btn-groups-single">Basic example<a class="  " href="#btn-groups-single"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-groups-toolbar">Button toolbar<a class="  " href="#btn-groups-toolbar"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-groups-sizing">Sizing<a class="  " href="#btn-groups-sizing"><span class="  "></span></a></h2>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group btn-group-xs"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-groups-nested">Nesting<a class="  " href="#btn-groups-nested"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-groups-vertical">Vertical variation<a class="  " href="#btn-groups-vertical"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-groups-justified">Justified button groups<a class="  " href="#btn-groups-justified"><span class="  "></span></a></h2>
        <p>Make a group of buttons stretch at equal sizes to span the entire width of its parent. Also works with button dropdowns within the button group.</p>

        <div class="bs-callout bs-callout-warning" id="callout-btn-group-justified-dbl-border">
            <h4 id="handling-borders">Handling borders<a class="  " href="#handling-borders"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-btn-group-ie8-border">
            <h4 id="ie8-and-borders">IE8 and borders<a class="  " href="#ie8-and-borders"><span class="  "></span></a></h4>
        ...
        <h4 id="with-<a>-elements">With <code>&lt;a&gt;</code> elements<a class="  " href="#with-&lt;a&gt;-elements"><span class="  "></span></a></h4>
        ...
        <div class="bs-example" data-example-id="simple-justified-button-group">
            ...
            <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group with nested dropdown">
                ...
                <a href="#" class="btn btn-default" role="button">Middle</a>
                <div class="btn-group" role="group">
                    <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Dropdown <span class="caret"></span>
                    </a>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h4 id="with-<button>-elements">With <code>&lt;button&gt;</code> elements<a class="  " href="#with-&lt;button&gt;-elements"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="btn-dropdowns" class="page-header">Button dropdowns<a class="  " href="#btn-dropdowns"><span class="  "></span></a></h1>
        ...
        <h2 id="btn-dropdowns-single">Single button dropdowns<a class="  " href="#btn-dropdowns-single"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-dropdowns-split">Split button dropdowns<a class="  " href="#btn-dropdowns-split"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-dropdowns-sizing">Sizing<a class="  " href="#btn-dropdowns-sizing"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="btn-dropdowns-dropup">Dropup variation<a class="  " href="#btn-dropdowns-dropup"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="input-groups" class="page-header">Input groups<a class="  " href="#input-groups"><span class="  "></span></a></h1>
        ...
        <div class="bs-callout bs-callout-danger" id="callout-inputgroup-text-input-only">
            <h4 id="textual-<input>s-only">Textual <code>&lt;input&gt;</code>s only<a class="  " href="#textual-&lt;input&gt;s-only"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-inputgroup-container-body">
            <h4 id="tooltips-&amp;-popovers-in-input-groups-require-special-setting">Tooltips &amp; popovers in input groups require special setting<a class="  " href="#tooltips-&amp;-popovers-in-input-groups-require-special-setting"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-inputgroup-dont-mix">
            <h4 id="H1">Don't mix with other components<a class="  " href="#don't-mix-with-other-components"><span class="  "></span></a></h4>
        ...
        <h2 id="input-groups-basic">Basic example<a class="  " href="#input-groups-basic"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="input-groups-sizing">Sizing<a class="  " href="#input-groups-sizing"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="input-groups-checkboxes-radios">Checkboxes and radio addons<a class="  " href="#input-groups-checkboxes-radios"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre>
        ...
        <h2 id="input-groups-buttons">Button addons<a class="  " href="#input-groups-buttons"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre>
        ...
        <h2 id="input-groups-buttons-dropdowns">Buttons with dropdowns<a class="  " href="#input-groups-buttons-dropdowns"><span class="  "></span></a></h2>
        <p></p>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre>
        ...
        <h2 id="input-groups-buttons-segmented">Segmented buttons<a class="  " href="#input-groups-buttons-segmented"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="nav" class="page-header">Navs<a class="  " href="#nav"><span class="  "></span></a></h1>

        <p class="lead">Navs available in Bootstrap have shared markup, starting with the base <code>.nav</code> class, as well as shared states. Swap modifier classes to switch between each style.</p>

        <div class="bs-callout bs-callout-info" id="callout-navs-tabs-plugin">
            <h4 id="using-navs-for-tab-panels-requires-javascript-tabs-plugin">Using navs for tab panels requires JavaScript tabs plugin<a class="  " href="#using-navs-for-tab-panels-requires-javascript-tabs-plugin"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navs-accessibility">
            <h4 id="make-navs-used-as-navigation-accessible">Make navs used as navigation accessible<a class="  " href="#make-navs-used-as-navigation-accessible"><span class="  "></span></a></h4>
        ...
        <h2 id="nav-tabs">Tabs<a class="  " href="#nav-tabs"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="nav-pills">Pills<a class="  " href="#nav-pills"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="nav-justified">Justified<a class="  " href="#nav-justified"><span class="  "></span></a></h2>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navs-justified-safari">
            <h4 id="safari-and-responsive-justified-navs">Safari and responsive justified navs<a class="  " href="#safari-and-responsive-justified-navs"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="nav-disabled-links">Disabled links<a class="  " href="#nav-disabled-links"><span class="  "></span></a></h2>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navs-anchor-disabled">
            <h4 id="link-functionality-not-impacted">Link functionality not impacted<a class="  " href="#link-functionality-not-impacted"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="nav-dropdowns">Using dropdowns<a class="  " href="#nav-dropdowns"><span class="  "></span></a></h2>
        <p>Add dropdown menus with a little extra HTML and the <a href="../javascript/#dropdowns">dropdowns JavaScript plugin</a>.</p>

        <h3 id="tabs-with-dropdowns">Tabs with dropdowns<a class="  " href="#tabs-with-dropdowns"><span class="  "></span></a></h3>
        <div class="bs-example" data-example-id="nav-tabs-with-dropdown">
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="#">Home</a></li>
                <li role="presentation"><a href="#">Help</a></li>
                <li role="presentation" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">Dropdown <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h3 id="pills-with-dropdowns">Pills with dropdowns<a class="  " href="#pills-with-dropdowns"><span class="  "></span></a></h3>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="navbar" class="page-header">Navbar<a class="  " href="#navbar"><span class="  "></span></a></h1>

        <h2 id="navbar-default">Default navbar<a class="  " href="#navbar-default"><span class="  "></span></a></h2>
        <p>Navbars are responsive meta components that serve as navigation headers for your application or site. They begin collapsed (and are toggleable) in mobile views and become horizontal as the available viewport width increases.</p>
        <p><strong class="text-danger">Justified navbar nav links are currently not supported.</strong></p>

        <div class="bs-callout bs-callout-warning" id="callout-navbar-overflow">
            <h4 id="overflowing-content">Overflowing content<a class="  " href="#overflowing-content"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-danger" id="callout-navbar-js">
            <h4 id="requires-javascript-plugin">Requires JavaScript plugin<a class="  " href="#requires-javascript-plugin"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-info" id="callout-navbar-breakpoint">
            <h4 id="changing-the-collapsed-mobile-navbar-breakpoint">Changing the collapsed mobile navbar breakpoint<a class="  " href="#changing-the-collapsed-mobile-navbar-breakpoint"><span class="  "></span></a></h4>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navbar-role">
            <h4 id="make-navbars-accessible">Make navbars accessible<a class="  " href="#make-navbars-accessible"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h2 id="navbar-brand-image">Brand image<a class="  " href="#navbar-brand-image"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h2 id="navbar-forms">Forms<a class="  " href="#navbar-forms"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/form&gt;</span></code></pre>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navbar-form-labels">
            <h4 id="H2">Always add labels<a class="  " href="#always-add-labels"><span class="  "></span></a></h4>
        ...
        <h2 id="navbar-buttons">Buttons<a class="  " href="#navbar-buttons"><span class="  "></span></a></h2>
        ...
        <h2 id="navbar-text">Text<a class="  " href="#navbar-text"><span class="  "></span></a></h2>
        ...
        <h2 id="navbar-links">Non-nav links<a class="  " href="#navbar-links"><span class="  "></span></a></h2>
        ...
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"navbar-text navbar-left"</span><span class="nt">&gt;</span>Signed in as <span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">class=</span><span class="s">"navbar-link"</span><span class="nt">&gt;</span>Mark Otto<span class="nt">&lt;/a&gt;&lt;/p&gt;</span></code></pre>
        </div>


        <h2 id="navbar-component-alignment">Component alignment<a class="  " href="#navbar-component-alignment"><span class="  "></span></a></h2>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-navbar-right-align">
            <h4 id="right-aligning-multiple-components">Right aligning multiple components<a class="  " href="#right-aligning-multiple-components"><span class="  "></span></a></h4>
        ...
        <h2 id="navbar-fixed-top">Fixed to top<a class="  " href="#navbar-fixed-top"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <div class="bs-callout bs-callout-danger" id="callout-navbar-fixed-top-padding">
            <h4 id="body-padding-required">Body padding required<a class="  " href="#body-padding-required"><span class="  "></span></a></h4>
        ...
        <h2 id="navbar-fixed-bottom">Fixed to bottom<a class="  " href="#navbar-fixed-bottom"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <div class="bs-callout bs-callout-danger" id="callout-navbar-fixed-bottom-padding">
            <h4 id="H3">Body padding required<a class="  " href="#body-padding-required"><span class="  "></span></a></h4>
        ...
        <h2 id="navbar-static-top">Static top<a class="  " href="#navbar-static-top"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h2 id="navbar-inverted">Inverted navbar<a class="  " href="#navbar-inverted"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="breadcrumbs" class="page-header">Breadcrumbs<a class="  " href="#breadcrumbs"><span class="  "></span></a></h1>
...
<span class="nt">&lt;/ol&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="pagination" class="page-header">Pagination<a class="  " href="#pagination"><span class="  "></span></a></h1>
        ...
        <h2 id="pagination-default">Default pagination<a class="  " href="#pagination-default"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h3 id="disabled-and-active-states">Disabled and active states<a class="  " href="#disabled-and-active-states"><span class="  "></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h3 id="sizing">Sizing<a class="  " href="#sizing"><span class="  "></span></a></h3>
...
<span class="nt">&lt;nav&gt;&lt;ul</span> <span class="na">class=</span><span class="s">"pagination pagination-sm"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/ul&gt;&lt;/nav&gt;</span></code></pre>
        ...
        <h2 id="pagination-pager">Pager<a class="  " href="#pagination-pager"><span class="  "></span></a></h2>
        <p>Quick previous and next links for simple pagination implementations with light markup and styles. It's great for simple sites like blogs or magazines.</p>

        <h3 id="default-example">Default example<a class="  " href="#default-example"><span class="  "></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h3 id="aligned-links">Aligned links<a class="  " href="#aligned-links"><span class="  "></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
        ...
        <h3 id="optional-disabled-state">Optional disabled state<a class="  " href="#optional-disabled-state"><span class="  "></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="labels" class="page-header">Labels<a class="  " href="#labels"><span class="  "></span></a></h1>

        <h2 id="example">Example<a class="  " href="#example"><span class="  "></span></a></h2>
        <div class="bs-example" data-example-id="labels-in-headings">
            <h1 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="  " href="#example-heading-new"><span class="  "></span></a></h1>
            <h2 id="H4">Example heading <span class="label label-default">New</span><a class="  " href="#example-heading-new"><span class="  "></span></a></h2>
            <h3 id="H5">Example heading <span class="label label-default">New</span><a class="  " href="#example-heading-new"><span class="  "></span></a></h3>
            <h4 id="H6">Example heading <span class="label label-default">New</span><a class="  " href="#example-heading-new"><span class="  "></span></a></h4>
            <h5 id="H7">Example heading <span class="label label-default">New</span><a class="  " href="#example-heading-new"><span class="  "></span></a></h5>
        ...
        <h2 id="available-variations">Available variations<a class="  " href="#available-variations"><span class="  "></span></a></h2>
...
<span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"label label-danger"</span><span class="nt">&gt;</span>Danger<span class="nt">&lt;/span&gt;</span></code></pre>
        ...
        <div class="bs-callout bs-callout-info" id="callout-labels-inline-block">
            <h4 id="have-tons-of-labels?">Have tons of labels?<a class="  " href="#have-tons-of-labels?"><span class="  "></span></a></h4>
    ...
    <div class="bs-docs-section">
        <h1 id="badges" class="page-header">Badges<a class="  " href="#badges"><span class="  "></span></a></h1>
...
<span class="nt">&lt;/button&gt;</span></code></pre>
        ...
        <h4 id="self-collapsing">Self collapsing<a class="  " href="#self-collapsing"><span class="  "></span></a></h4>
        ...
        <h4 id="adapts-to-active-nav-states">Adapts to active nav states<a class="  " href="#adapts-to-active-nav-states"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="jumbotron" class="page-header">Jumbotron<a class="  " href="#jumbotron"><span class="  "></span></a></h1>
        ...
        <div class="bs-example" data-example-id="simple-jumbotron">
            <div class="jumbotron">
                <h1 id="hello,-world!">Hello, world!<a class="  " href="#hello,-world!"><span class="  "></span></a></h1>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="page-header" class="page-header">Page header<a class="  " href="#page-header"><span class="  "></span></a></h1>

        <p>A simple shell for an <code>h1</code> to appropriately space out and segment sections of content on a page. It can utilize the <code>h1</code>'s default <code>small</code> element, as well as most other components (with additional styles).</p>
        <div class="bs-example" data-example-id="simple-page-header">
            <div class="page-header">
                <h1 id="example-page-header-subtext-for-header">Example page header <small>Subtext for header</small><a class="  " href="#example-page-header-subtext-for-header"><span class="  "></span></a></h1>
            </div>
        </div>
        <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div>
        <div class="highlight">
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="thumbnails" class="page-header">Thumbnails<a class="  " href="#thumbnails"><span class="  "></span></a></h1>
        ...
        <h2 id="thumbnails-default">Default example<a class="  " href="#thumbnails-default"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="thumbnails-custom-content">Custom content<a class="  " href="#thumbnails-custom-content"><span class="  "></span></a></h2>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3 id="thumbnail-label">Thumbnail label<a class="  " href="#thumbnail-label"><span class="  "></span></a></h3>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img data-src="holder.js/100%x200" alt="100%x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
                        <div class="caption">
                            <h3 id="H8">Thumbnail label<a class="  " href="#thumbnail-label"><span class="  "></span></a></h3>
                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                            <p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img data-src="holder.js/100%x200" alt="100%x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
                        <div class="caption">
                            <h3 id="H9">Thumbnail label<a class="  " href="#thumbnail-label"><span class="  "></span></a></h3>
                            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                            <p><a href="#" class="btn btn-primary" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
                        </div>
                    </div>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="alerts" class="page-header">Alerts<a class="  " href="#alerts"><span class="  "></span></a></h1>
        ...
        <h2 id="alerts-examples">Examples<a class="  " href="#alerts-examples"><span class="  "></span></a></h2>
        <p>Wrap any text and an optional dismiss button in <code>.alert</code> and one of the four contextual classes (e.g., <code>.alert-success</code>) for basic alert messages.</p>

        <div class="bs-callout bs-callout-info" id="callout-alerts-no-default">
            <h4 id="no-default-class">No default class<a class="  " href="#no-default-class"><span class="  "></span></a></h4>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-danger"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="alerts-dismissible">Dismissible alerts<a class="  " href="#alerts-dismissible"><span class="  "></span></a></h2>
        <p>Build on any alert by adding an optional <code>.alert-dismissible</code> and close button.</p>
        <div class="bs-callout bs-callout-info" id="callout-alerts-dismiss-plugin">
            <h4 id="requires-javascript-alert-plugin">Requires JavaScript alert plugin<a class="  " href="#requires-javascript-alert-plugin"><span class="  "></span></a></h4>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <div class="bs-callout bs-callout-warning" id="callout-alerts-dismiss-use-button">
            <h4 id="ensure-proper-behavior-across-all-devices">Ensure proper behavior across all devices<a class="  " href="#ensure-proper-behavior-across-all-devices"><span class="  "></span></a></h4>
            <p>Be sure to use the <code>&lt;button&gt;</code> element with the <code>data-dismiss="alert"</code> data attribute.</p>
        </div>

        <h2 id="alerts-links">Links in alerts<a class="  " href="#alerts-links"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="progress" class="page-header">Progress bars<a class="  " href="#progress"><span class="  "></span></a></h1>

        <p class="lead">Provide up-to-date feedback on the progress of a workflow or action with simple yet flexible progress bars.</p>

        <div class="bs-callout bs-callout-danger" id="callout-progress-animation-css3">
            <h4 id="H10">Cross-browser compatibility<a class="  " href="#cross-browser-compatibility"><span class="  "></span></a></h4>
            <p>Progress bars use CSS3 transitions and animations to achieve some of their effects. These features are not supported in Internet Explorer 9 and below or older versions of Firefox. Opera 12 does not support animations.</p>
        </div>

        <h2 id="progress-basic">Basic example<a class="  " href="#progress-basic"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="progress-label">With label<a class="  " href="#progress-label"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="progress-alternatives">Contextual alternatives<a class="  " href="#progress-alternatives"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="progress-striped">Striped<a class="  " href="#progress-striped"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="progress-animated">Animated<a class="  " href="#progress-animated"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="progress-stacked">Stacked<a class="  " href="#progress-stacked"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="media" class="page-header">Media object<a class="  " href="#media"><span class="  "></span></a></h1>

        <p class="lead">Abstract object styles for building various types of components (like blog comments, Tweets, etc) that feature a left- or right-aligned image alongside textual content.</p>

        <h2 id="media-default">Default media<a class="  " href="#media-default"><span class="  "></span></a></h2>
        ...
        <div class="bs-example" data-example-id="default-media">
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="media-heading">Media heading<a class="  " href="#media-heading"><span class="  "></span></a></h4>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="H11">Media heading<a class="  " href="#media-heading"><span class="  "></span></a></h4>
                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
        <div class="media">
            <div class="media-right">
                <a href="#">
            ...
            <div class="media-body">
                <h4 class="media-heading" id="nested-media-heading">Nested media heading<a class="  " href="#nested-media-heading"><span class="  "></span></a></h4>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
            </div>
        </div>
                </div>
            ...
            <div class="media">
                <div class="media-body">
                    <h4 class="media-heading" id="H12">Media heading<a class="  " href="#media-heading"><span class="  "></span></a></h4>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="H13">Media heading<a class="  " href="#media-heading"><span class="  "></span></a></h4>
                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                </div>
                <div class="media-left">
                    <a href="#">
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <p>The classes <code>.pull-left</code> and <code>.pull-right</code> also exist and were previously used as part of the media component, but are deprecated for that use as of v3.3.0. They are approximately equivalent to <code>.media-right</code> and <code>.media-right</code>, except that <code>.media-right</code> should be placed after the <code>.media-body</code> in the html.</p>
        <h2 id="media-alignment">Media alignment<a class="  " href="#media-alignment"><span class="  "></span></a></h2>
        ...
        <div class="bs-example" data-example-id="media-alignment">
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="top-aligned-media">Top aligned media<a class="  " href="#top-aligned-media"><span class="  "></span></a></h4>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="middle-aligned-media">Middle aligned media<a class="  " href="#middle-aligned-media"><span class="  "></span></a></h4>
                    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    <p>Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                </div>
            </div>
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading" id="bottom-aligned-media">Bottom aligned media<a class="  " href="#bottom-aligned-media"><span class="  "></span></a></h4>
                    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    <p>Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                </div>
            </div>
        ...
        <div class="highlight">
            <pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"media"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"media-right media-middle"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span><span class="nt">&gt;</span>
      <span class="nt">&lt;img</span> <span class="na">class=</span><span class="s">"media-object"</span> <span class="na">src=</span><span class="s">"..."</span> <span class="na">alt=</span><span class="s">"..."</span><span class="nt">&gt;</span>
    <span class="nt">&lt;/a&gt;</span>
  <span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="media-list">Media list<a class="  " href="#media-list"><span class="  "></span></a></h2>
        ...
        <div class="bs-example" data-example-id="media-list">
            <ul class="media-list">
                <li class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading" id="H14">Media heading<a class="  " href="#media-heading"><span class="  "></span></a></h4>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading" id="H15">Nested media heading<a class="  " href="#nested-media-heading"><span class="  "></span></a></h4>
                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
              <!-- Nested media object -->
                                <div class="media">
                                    <div class="media-right">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading" id="H16">Nested media heading<a class="  " href="#nested-media-heading"><span class="  "></span></a></h4>
                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading" id="H17">Nested media heading<a class="  " href="#nested-media-heading"><span class="  "></span></a></h4>
                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                            </div>
                        </div>
                    </div>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="list-group" class="page-header">List group<a class="  " href="#list-group"><span class="  "></span></a></h1>
        ...
        <h2 id="list-group-basic">Basic example<a class="  " href="#list-group-basic"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="list-group-badges">Badges<a class="  " href="#list-group-badges"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/ul&gt;</span></code></pre>
        ...
        <h2 id="list-group-linked">Linked items<a class="  " href="#list-group-linked"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="list-group-disabled">Disabled items<a class="  " href="#list-group-disabled"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="list-group-contextual-classes">Contextual classes<a class="  " href="#list-group-contextual-classes"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="list-group">
      ...
      <a href="#" class="list-group-item">
        <h4 class="list-group-item-heading" id="H18">List group item heading </h4>
        <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
      </a>
      <a href="#" class="list-group-item">
        <h4 class="list-group-item-heading" id="H19">List group item heading </h4>
        <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
      </a>
    </div>
  </div>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="panels" class="page-header">Panels<a class="  " href="#panels"><span class="  "></span></a></h1>
        ...
        <h2 id="panels-basic">Basic example<a class="  " href="#panels-basic"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="panels-heading">Panel with heading<a class="  " href="#panels-heading"><span class="  "></span></a></h2>
        ...
        <div class="bs-example" data-example-id="panel-with-heading">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" id="panel-title">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="panels-footer">Panel with footer<a class="  " href="#panels-footer"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="panels-alternatives">Contextual alternatives<a class="  " href="#panels-alternatives"><span class="  "></span></a></h2>
        <p>Like other components, easily make a panel more meaningful to a particular context by adding any of the contextual state classes.</p>
        <div class="bs-example" data-example-id="contextual-panels">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title" id="H20">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title" id="H21">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" id="H22">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title" id="H23">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title" id="H24">Panel title<a class="  " href="#panel-title"><span class="  "></span></a></h3>
                </div>
                <div class="panel-body">
                    Panel content
                </div>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-danger"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="panels-tables">With tables<a class="  " href="#panels-tables"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
        ...
        <h2 id="panels-list-group">With list groups<a class="  " href="#panels-list-group"><span class="  "></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="responsive-embed" class="page-header">Responsive embed<a class="  " href="#responsive-embed"><span class="  "></span></a></h1>
...
<span class="nt">&lt;/div&gt;</span></code></pre>
    ...
    <div class="bs-docs-section">
        <h1 id="wells" class="page-header">Wells<a class="  " href="#wells"><span class="  "></span></a></h1>

        <h2 id="default-well">Default well<a class="  " href="#default-well"><span class="  "></span></a></h2>
        ...
        <h2 id="optional-classes">Optional classes<a class="  " href="#optional-classes"><span class="  "></span></a></h2>
...
<asp:Content ID="Content4" ContentPlaceHolderID="RightPlaceHolder" runat="Server">
    <nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix-top">
        ...
        <a href="#" class="bs-docs-theme-toggle" role="button">Preview theme
        </a>
